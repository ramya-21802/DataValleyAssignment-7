...
public class HousePrice {
    ...
    public static void main(String[] args) {
        ...
        houses.add(new House(800000, 1500));
        houses.add(new House(700000, 1200));
        houses.add(new House(300000, 900));
        houses.add(new House(450000, 200));
        houses.add(new House(270000, 1700));
        houses.add(new House(650000, 1900));
